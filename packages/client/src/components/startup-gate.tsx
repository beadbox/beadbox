...
import {
  ...
  BdUpgradeInstructions,
  type PlatformFlags,
} from "./bd-install-instructions"
...
// Moved to bd-install-instructions.tsx (beadbox-ag1) so every bd install /
// upgrade hint shares one macOS-only brew branch.
